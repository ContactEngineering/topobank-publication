...
def test_api():
    ...
    assert reverse('publication:surface-publication-rate-too-high', kwargs=dict(pk=123)) == '/go/html/publish/123/publication-rate-too-high/'
    assert reverse('publication:surface-publication-error', kwargs=dict(pk=123)) == '/go/html/publish/123/publication-error/'
