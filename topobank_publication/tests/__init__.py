from topobank.analysis.functions import (
    VIZ_SERIES, surface_analysis_function_for_tests,
    tag_analysis_function_for_tests, topography_analysis_function_for_tests)
...
register_implementation(app_name, VIZ_SERIES, "test")(
